...
export class StatusBarUi {
  ...
  static watching() {
    ...
    StatusBarUi.statusBarItem.command = "liveStylus.command.donotWatchMyStylus";
    StatusBarUi.statusBarItem.tooltip =
      "Stop live compilation of Stylus or Stylus to CSS";
  }

  static notWatching() {
    StatusBarUi.statusBarItem.text = `$(eye) Watch Stylus`;
    StatusBarUi.statusBarItem.color = "inherit";
    StatusBarUi.statusBarItem.command = "liveStylus.command.watchMyStylus";
    StatusBarUi.statusBarItem.tooltip =
      "live compilation of Stylus or Stylus to CSS";
  }
